...
import/websites/gr.maharashtra.gov.in/Women:
	cd import/websites/gr.maharashtra.gov.in/ && ln -s $(GR_DIR)/Women .
...
import: check_env import/websites/gr.maharashtra.gov.in/Women .secrets/google.token 
	poetry run python import/src/build_documents.py import/websites/gr.maharashtra.gov.in/Women import/documents
